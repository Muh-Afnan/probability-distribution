...
from distribution import Exponential, Gaussian, Poisson, Binomial, Bernoulli


def plot_distribution_gallery(distributions: dict):
    """
    distributions = {
...
plot_distribution_gallery({
    ...
    "Poisson(3)": Poisson(3),
    "Binomial(0.5,10)": Binomial(0.5, 10),
